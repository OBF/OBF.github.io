...
![Presenting my work in the joint BOSC/BOKR session](/img/2026/2026-07-16-me-presenting.png)
Throughout BOSC, speakers emphasized the importance of FAIR data, interoperability, genomic standards, scalable data integration, and reproducible computational biology. As biological datasets continue to grow, ensuring that data can be interpreted and reused across platforms has become as important as generating the data itself. It was encouraging to see so many researchers developing open standards and infrastructure that make collaborative science possible.
Three BOSC talks stood out to me because of how helpful they were to my own research.
The first was "KG-Registry: The Open Registry of Knowledge Graphs and Their Provenance," presented by J. Harry Caufield. Knowledge graphs are important for integrating diverse biomedical datasets, but finding appropriate knowledge graphs and understanding where their information comes from can be difficult. The KG-Registry addresses this challenge by creating an open registry that improves both discoverability and provenance. Documenting data sources and relationships is essential for building trust in integrated biomedical knowledge.
Another highlight was "Scalable Representation of Categorical Genomic Variation Using Cat-VRS," presented by Daniel Puthawala from Nationwide Children's Hospital. Cat-VRS extends existing genomic variation standards to better represent categorical and complex genomic variation in a consistent way. As someone whose own research focuses on standardizing ambiguous biological terminology, I found this presentation particularly relevant. Whether working with gene symbols or genomic variants, standardized representations reduce ambiguity, improve communication between databases (and people!), and enable more reliable computational analyses.
